...
[
    {   questionText:"1. Skupina občanů často kritizuje rozhodnutí právoplatně zvolené Rady ostrova. To zpomaluje a komplikuje výkon vašich rozhodnutí. Tito občané založili politickou skupinu a získávají si na ostrově stále více příznivců.",
        ...
        [
            {   optionText:"Ponecháte záležitosti volný vývoj s tím, že skupinu omezíte pouze v případě, že začne vystupovat proti právům jiných lidí.",
                optionLaw:"JE ZARUČENA SVOBODA PROJEVU A POLITICKÉHO SDRUŽOVÁNÍ.",
                optionPersonas: 
                [
                    {   personaName:"predseda", 
                        personaText:"Ve svobodných volbách jste se svým programem oslovili velkou většinu občanů. Tyto zatím poslední volby jste sice nevyhráli, ale ty ses stal předsedou nejsilnější opoziční strany."
                    },
                    {   personaName:"feministka", 
                        personaText:"Jsi ráda, že existuje více politických stran a že se politici musí za to, co dělají, zodpovídat voličům. Budeš rozhodně podporovat strany, které respektují ženy i muže stejně. A to i v politice. "
                    },
            ...
            {   optionText:"Zakážete činnost této skupiny a uvězníte lidi, kteří nebudou vaše rozhodnutí respektovat.",
                ...
                [
                    {   personaName:"predseda", 
                        personaText:"Omezování jiných stran, než té jedné vládnoucí začalo šikanou od úřadů, vyšetřováním financování strany. Jsi obviněn z protistátní činnosti, řada tvých kolegů je ve vězení a tvá strana je zakázána."
                    },
                    {   personaName:"feministka", 
                    ...
                    {   personaName:"byvaly bezdomovec", 
                        personaText:"Vládnoucí strana omezovala a nakonec zakázala všechny ostatní strany. Řada lidí z opoziční strany, která se s vaší organizací radila, je ve vězení. Není šance, že by se změnil život lidí bez domova tak, jak jsi chtěl."
                    },
                    {   personaName:"Romka",
            ...
            {   optionText:"Necháte skupinu formálně fungovat, ale zamezíte její účasti v příštích volbách do Rady ostrova.",
                ...
                [
                    {   personaName:"predseda",
                        personaText:"Proti vaší vůli a prostestům byl přijat zákon omezující financování naší strany a pak vám bylo znemožněno abychom vůbec kandidovali v příštích volbách. "
                    },
                    {   personaName:"feministka",
                        personaText:" Vždy ti byla sympatická Demokratická strana ostrova (DSO), která dbala na rovné příležitosti pro ženy i muže. Teď po nemožnosti jiných stran kandidovat do parlamentu jsou šance na změnu v postavení žen mizivé."
                    },
                    {   personaName:"byvaly bezdomovec",
    ...
    {   questionText:"2. Z jiného ostrova připlulo asi 500 lidí. Někteří utíkají před diktátorským režimem a válkou. Jiní hledají lepší podmínky pro život. Tito lidé mají jiné zvyky a přicházejí bez prostředků.",
        questionOptions:
        [
            {   optionText:"Přijmete všechny bez rozlišení, komu opravdu hrozí nebezpečí a dovolíte jim, aby s vámi žili na ostrově.",
                ...
                [
                    {   personaName:"predseda",
                        personaText:"Trvalo dlouhé roky, než na ostrov přišla zpráva o dalších přeživších. Souhlasil jsi s materiální pomocí všem příchozím lidem bez rozlišování důvodů. Následovali pak další a další lidi, kteří přicházeli s vidinou snadnějšího života. To tě může stát funkci předsedy strany."
                    },
                    {   personaName:"feministka",
                    ...
                    {   personaName:"Romka",
                        personaText:"Máš strach z nově příchozích lidí. Ve zprávách říkali, že konflikt, kvůli kterému utíkají, je strašně nepřehledný, co když jsou mezi nimi teroristé nebo sem přinesou nějaké nemoci?"
                    }          
                ]
            },
            {   optionText:"Odmítnete je všechny s tím, aby pokračovali v cestě.",
                optionLaw:"ODMÍTÁTE VŠECHNY NOVĚ PŘÍCHOZÍ, VČETNĚ TĚCH, KTEŘÍ UTÍKAJÍ Z VÁLKY A HROZÍ JIM PRONÁSLEDOVÁNÍ.",
                optionPersonas:
                [
                    {   personaName:"predseda",
                        personaText:"Trvalo dlouhé roky, než na ostrov přišla zpráva o dalších přeživších. Zákony však odmítají všechny migranty. Nesouhlasil jsi. Navrhl jsi nový zákon, který by umožnil pomoci aspoň těm, kterým hrozí nebezpečí při návratu. Tím strana ztratila část voličů, kteří se cizinců báli."
                    },
                    {   personaName:"feministka",
                        personaText:"Trvalo dlouhé roky, než na ostrov přišla zpráva o dalších přeživších. Když přijela loď s migranty k ostrovu, byli mezi nimi i dva tví bratranci. Byla jsi zoufalá, když ses dozvěděla, že tvá zěmě odmítá kohokoli vpustit. Od doby, co odpluli, o nich nemáš žádnou zprávu."
                    },
                    {   personaName:"byvaly bezdomovec",
                    ...
                    {   personaName:"Romka",
                        personaText:"Cítíš úlevu, pro cizí lidi na ostrově není místo. Sami máte svých problémů dost. Ve zprávách říkali, že konflikt, kvůli kterému utíkají, je strašně nepřehledný, mohli mezi nimi být teroristé nebo sem přinést nemoci."
                    }
                ]    
            }, 
            {   optionText:"Přijmete pouze ty běžence, kteří prokáží, že jim v jejich vlasti opravdu hrozí vážné nebezpečí.",
                optionLaw:"POMOC A PŘIJETÍ MIGRANTŮ SE POSUZUJE U KAŽDÉHO ZVLÁŠŤ PODLE ZÁVAŽNOSTI DŮVODŮ JEJICH ÚTĚKU.",
                optionPersonas:
                [
                    {   personaName:"predseda",
                    ...
                    {   personaName:"feministka",
                        personaText:"Trvalo dlouhé roky, než na ostrov přišla zpráva o dalších přeživších mezi nimi i tví bratranci. Těm v jejich zemi hrozí smrt. Byla jsi šťastná, když jsi je viděla na lodi spolu s dalšími migranty. Víš, že nyní jsou v bezpečí, protože platí zákon, který pomáhá pronásledovaným."
                    },
                    {   personaName:"byvaly bezdomovec",
                    ...
                    {   personaName:"Romka",
                        personaText:"Jsi sice ráda, že vláda na ostrov pustila nově příchozí lidi a všechny důkladě prověřuje, ale i tak se bojíš.  Ve zprávách říkali, že konflikt, kvůli kterému utíkají, je strašně nepřehledný, mohou mezi nimi být teroristé nebo sem přinést nemoci."
                    }
                ]
            }    
        ]
    },
    {   questionText:"3. Osmnáctiletá dívka se u úřadů dovolává pomoci, protože jí rodina zakazuje sňatek a hrozí jí vyhnáním z domu. Tradice, k níž se její rodina hlásí, přikazuje, že výběr životního partnera závisí na rozhodnutí rodičů.",
        questionOptions:
        [
            {   optionText:"Nebudete dívce pomáhat, protože jde o soukromou záležitost.",
                ...
                [
                    {   personaName:"predseda",
                        personaText:" Tvá strana hlásí, že rodinný a soukromý život je nedotknutelný. Stát podle vás prostě nesmí zasahovat do soukromých záležitostí."
                    },
                    {   personaName:"feministka",
                        personaText:"Všichni tě znají jako aktivistku za práva žen, včetně boje proti nuceným sňatkům. Málokdo ale ví, že jednou z takových dívek byla i tvá matka. Byla donucená vzít si člověka, kterého neznala a který vás obě bil."
                    },
                    {   personaName:"byvaly bezdomovec",
            ...
            {   optionText:"Zakážete tradici týkající se výběru partnerů rodiči a budete trestat dodržování této tradice.",
                optionLaw:"JSOU ZAKÁZÁNY NUCENÉ SŇATKY A DODRŽOVÁNÍ TĚCHTO TRADIC (JAKO JE VÝBĚR PARTNERA RODIČI) JE TRESTÁNO.",
                optionPersonas:
                [
                    {   personaName:"predseda",
                        personaText:"V otázce rozhodování o sňatku se vaše strana neodváží jít proti svým voličům. Drží tedy postoj, že stát prostě nesmí zasahovat do rodinného života."
                    },
                    {   personaName:"feministka",
                        personaText:"Všichni tě znají jako aktivistku za práva žen, včetně boje proti nuceným sňatkům. Málokdo ale ví, že jednou z takových dívek byla i tvá matka. Byla donucená vzít si člověka, kterého neznala a který vás obě bil."
                    },
                    {   personaName:"byvaly bezdomovec",
                        personaText:"Při své práci málokdy střetáváš mladé dívky. Jsi rád, že stát se stará, aby nucené sňatky nebyly možné. Umíš si představit, jak by skončila mladá dívka, kdyby ji rodiče vyhodili z domu a žila by na ulici."
                    },
                    {   personaName:"Romka",
                        personaText:"Když ti bylo 18 let, rodiče ti domluvili sňatek proti tvé vůli. Obrátila ses nakonec na úřady, které se tě zastaly a pomohly, protože nucené sňatky jsou přísně trestány."
                    }
                ]    
           }, 
           {    optionText:" Z veřejných zdrojů dívce zajistíte dočasné bydlení a pokusíte se zprostředkovat dialog s její rodinou.",
                ...
                [
                    ...
                    {   personaName:"byvaly bezdomovec",
                        personaText:"Jsi rád, že stát se stará o mladé dívky, které jsou ve sporu s rodinou. Umíš si totiž představit, jak by skončila mladá dívka, kdyby ji rodiče vyhodili z domu a žila by na ulici."
                    },
                    {   personaName:"Romka",
                        personaText:"Když ti bylo 18 let, rodiče ti domluvili sňatek proti tvé vůli. Obrátila ses nakonec na úřady, které ti zprostředkovaly prostředníka, a nakonec se ti podařilo s rodiči domluvit. Našli jste cestu, jak komunikovat."
                    }
                ]
            }    
        ]
        ...
        [
            {   optionText:"Budete činnost této skupiny ignorovat.",
                ...
                [
                    ...
                    {   personaName:"byvaly bezdomovec",
                        personaText:"Jedna skupina prosazuje beztrestné násilí na lidech bez domova, prý že tím pomáhají ostrovu zbavit se přítěže. Tato skupina je čím dál populárnější. Každý den se stane, že někdo zkope bezdomovce, jen tak pro zábavu. Došlo už i k několika případům zabití."
                    },
                    {   personaName:"Romka",
                        personaText:"Jako Romka máš strach, kam povede stále oblíbenější hnutí proti právům menšin. Co když tato skupina nakonec získá skutečnou moc? Co když začne vytvářet koncentráky pro Romy? Už teď cítíš nenávist od ostatních lidí kvůli své barvě pleti."
                    }          
                ]
            },
            ...
            {   optionText:"Zakážete činnost této skupiny a budete trestat veřejné prosazování podobných nenávistných a diskriminačních opatření.",
                ...
                [
                    {   personaName:"predseda",
                        personaText:"Jako známý politik, který se netají svou homosexualitou, to nemáš lehké, ale víš, že když by někdo chtěl tvá práva omezit, policie zasáhne. Jako když zaktla muže, co ti vyhrožoval smrtí."
                    },
                    {   personaName:"feministka",
                    ...
                    {   personaName:"Romka",
                        personaText:"Nestydíš se za svůj původ a jinou barvu pleti. Díky zákonu chránící práva všech jsou tvá práva stejná jako má většinová společnost. Cítíš se bezpečně a důstojně, máš jistotu, že stát tě ochrání."
                    }
                ]
            }    
        ]
    ...
    {   questionText:"5. Několik rodin se chce odstěhovat za prací do jiné části ostrova mimo hlavní město. Tak velká vzdálenost by zkomplikovala a prodražila dohled úřadů nad jejich činností.",
        questionOptions:
        [
            {   optionText:"Zakážete lidem z hlavního města se volně stěhovat po ostrově.",
                optionLaw:"JE ZAKÁZÁNO STĚHOVAT SE Z HLAVNÍHO MĚSTA.",
                optionPersonas:
                [
                    {   personaName:"predseda",
                        personaText:"Jako strana usilujete o zrušení přežitého zákazu volného pohybu. S bratrem máte navíc na jihu ostrova prosperující zemědělskou výrobu a zákaz vám komplikuje získávání nových pracovníků a rozvoj byznysu."
                    },
                    {   personaName:"feministka",
                        personaText:"Celý život žiješ v hlavním městě, zákaz přestěhování se do jiných částí ostrova se tě nijak nedotýká. Ze své práce ale víš o ženách, které chtěly utéct před násilnými manžely na venkov, ale nemohly."
                    },
                    {   personaName:"byvaly bezdomovec",
                        personaText:"Když jsi byl bezdomovcem už několik let, chtěl ses přestěhovat na venkov, kde by sis mohl pěstovat vlastní jídlo a začít nový život. To kvůli zákazu stěhování z města nebylo možné, ve městě bylo velmi těžké najít práci a začít znovu."
                    },
                    {   personaName:"Romka",
                        personaText:"Trápí tě astma a lékař ti dopuručil vyhnout se smogu hlavního města. Chtěla ses proto s rodinou přestěhovat na venkov, ale to je zakázáno. "
                    }          
                ]
            },
            {   optionText:"Umožníte volné stěhování obyvatel.",
                ...
                [
                    ...
                    {   personaName:"byvaly bezdomovec",
                        personaText:"Když jsi byl bezdomovcem už několik let, rozhodl ses odstěhovat na venkov, kde jsi začal pěstovat a pak i prodávat zeleninu. Díky tomu ses dostal z ulice a dnes můžeš pomáhat dalším lidem bez domova."
                    },
                    {   personaName:"Romka",
                        personaText:"Trápí tě astma a na doporučení lékaře ses odstěhovala se svou rodinou na venkov, bez žádných omezení ze strany státu. Čistý vzduch venkova ti svědčí."
                    }
                ]    
            }, 
            {   optionText:"Povolení ke stěhování bude podmíněno zaplacením vysokého poplatku a bude záviset na rozhodnutí úřadu.",
                ...
                [
                    ...
                    {   personaName:"byvaly bezdomovec",
                        personaText:"Když jsi byl bezdomovcem už několik let, chtěl ses přestěhovat na venkov, kde by sis mohl pěstovat vlastní jídlo a začít nový život. Na to jsi ale neměl peníze. Musel jsi zůstat ve městě, kde bylo mnohem náročnější dostat se z ulice."
                    },
                    {   personaName:"Romka",
                        personaText:"Trápí tě astma a lékař ti dopuručil vyhnout se smogu hlavního města. Chtěla ses s rodinou přestěhovat na vekov, o čemž musel rozhodnout úředník. Narazili jste na úředníka, který přiznal, že nesnáší Romy a povolení vám nedal."
                    }
                ]
            }    
        ]
    },
    {   questionText:"6. Jeden z členů Rady ostrova prosazuje názor, že efektivní rozvoj země je možný jen tehdy, budou-li mít volební právo pouze kvalitní voliči.",
        questionOptions:
        [
    ...
    {   questionText:"7. Určité skupiny obyvatel (staří lidé, děti bez rodičů, nemocní, bezdomovci) trpí hladem a špatnými životními podmínkami. Asi dvacet z nich již následkem toho zemřelo",
        ...
        [
            { optionText:"Za cenu poměrně velkých výdajů z daní zajistíte těmto ohroženým skupinám základní životní potřeby a budete usilovat o zlepšení jejich situace.",
                ...
                [
                    ...
                    {   personaName:"feministka",
                        personaText:"Maminka ti před rokem těžce onemocněla. Ve svém věku jsi na to nebyla připravená. Jelikož ale stát v takových situacích alespoň materiálně pomáhá, dá se to vcelku zvládat."
                    },
                    {   personaName:"byvaly bezdomovec",
            ...
            {   optionText:"Nepodniknete v této záležitosti nic.",
                ...
                [
                    ...
                    {   personaName:"byvaly bezdomovec",
                        personaText:" Z ulice ses musel dostat sám, spoustu tvých kamarádů na ulici bez pomoci zemřelo. Stát neposkytuje pomoc, neexistuje žádná sociální práce ani finanční podpora pro lidi v nouzi."
                    },
                    {   personaName:"Romka",
        ...
        {    optionText:"Donutíte ty, kdo jsou schopní fyzické práce (včetně dětí a starých lidí), aby vydělávali na pokrytí svých životních potřeb. Ostatním zajistíte základní pomoc.",
                ...
                [
                    ...
                    {   personaName:"byvaly bezdomovec",
                        personaText:"Byl jsi nucen pracovat manuálně v dole na těžbu uhlí, když jsi byl na ulici. Tuto práci ti přidělili i přesto, že jsi měl zdravotní problémy, podle úřadů jsi ale byl schopný fyzické práce. Podepsalo se to na tvém zdraví a skončil jsi na vozíku."
                    },
                    {   personaName:"Romka",
                        personaText:"Tví prarodiče jsou na tom špatně, jsou staří, ale pořád musí pracovat, protože nemají žádnou vážnou nemoc. Ale jejich zdraví se postupně zhoršuje. Kdyby měli nárok na finanční podporu, mohli už být v důchodu a užívat si spokojeného života."
                    }
                ]
        }    
    ]
